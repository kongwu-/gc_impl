...
//#ifndef GC_IMPL_REFERENCE_COUTING_GC_H
//#define GC_IMPL_REFERENCE_COUTING_GC_H
//
//#endif //GC_IMPL_REFERENCE_COUTING_GC_H
 ...
 * @param obj 新对象指针
 */
extern void gc_update_ptr(void** ptr, object *obj);

/**
 * 将对象添加到GC ROOTS，这里因为没有tracing的需求，所以直接更新计数器，不再维护roots
 */
extern void gc_add_root(object *p);

/**
 * 将对象从GC ROOTS移除，模拟变量出栈
 * @param p
 */
extern void gc_remove_root(object *p);
/**
 * 暂存GC ROOTS下标
 */
